...
class sqlite_database():
    def __init__(self) -> None:
        ...
        self.conn_l = sql.connect('res/component.db')  # локальный обьект класса
...
if __name__ == '__main__':
    ...
    #добавление номиналов рещисторов
    ...
    # db.copy_new_datasheets(list_diodes)#ПОХОЖЕ НЕ БЫЛ РЕАЛИЗОВАН ВООБЩЕ
